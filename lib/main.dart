    ...
    return Scaffold(
      body: Stack(children: [
        ...
        SafeArea(child: Column(children: [
          ...
          SingleChildScrollView(scrollDirection: Axis.horizontal, padding: const EdgeInsets.symmetric(horizontal: 16, vertical: 8), child: Row(children: [_buildFilterChip('すべて'), _buildFilterChip('急速'), _buildFilterChip('テスラ'), _buildFilterChip('普通'), _buildFilterChip('6kW')])),
